      ...
      <div className="intro-card">
        ...
        <div className="intro-text">
          ...
          <p>
            ...
            Users can choose from various brush sizes and colors, and even toggle a grid overlay to help with alignment. Check out a demo video below and access the website here:.
          </p>
        </div>
      </div>
